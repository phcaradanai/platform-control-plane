    ...
    <div className="space-y-8">
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Generated by the Platform MFE Application template — a
          production-ready React + Vite + TypeScript foundation.
        </p>
      </section>
      ...
      <dl className="mt-4 space-y-3 text-sm">
        ...
        <div className="flex justify-between gap-4">
          <dt className="text-muted-foreground">
            Current path (via useNavigation)
          </dt>
        ...
        <div className="flex justify-between gap-4">
          ...
          <dd>
            <Badge
              variant={permissions.status === 'ready' ? 'default' : 'outline'}
            >
              {permissions.status}
            </Badge>
          </dd>

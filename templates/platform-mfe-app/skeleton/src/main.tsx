...
try {
  ...
  // Resolve the host first. configurePlatformAuth only creates the local
  // OIDC/standalone fallback when the host does not supply auth.
  configurePlatformAuth(runtime.adapters?.auth);
  root.render(
    <StrictMode>
      <App runtime={runtime} />
    </StrictMode>,
